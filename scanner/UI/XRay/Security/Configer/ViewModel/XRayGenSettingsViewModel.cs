...
namespace UI.XRay.Security.Configer.ViewModel
{
    ...
    public class XRayGenSettingsViewModel : ViewModelBase, IViewModel
    {
        ...
        public XRayGeneratorType XRayGenType
        {
            ...
            {
                _xrayGenType = value;
                if (_xrayGenType == XRayGeneratorType.XRayGen_KWA)
                {
                    NotKWA = false;
                }
                else
        ...
        private bool _notKWA;

        public bool NotKWA
        {
            get { return _notKWA; }
            set { _notKWA = value; RaisePropertyChanged(); }
        }
        ...
        public XRayGenSettingsViewModel()
        {
            ...
            XRayGenTypes = new List<XRayGeneratorType>
            {
                ...
                XRayGeneratorType.XRayGen_VJ160_A,
        ...
        public void SaveSettings()
        {
            ...
            {
                MessageBox.Show(LanguageResourceExtension.FindTranslation("Configer", "Failed to save settings into Control Board System."), "Error",
