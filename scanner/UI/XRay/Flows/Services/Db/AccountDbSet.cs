...
namespace UI.XRay.Flows.Services.Db
{
    ...
    public class AccountDbSet
    {
        ...
        public List<Account> SelectAll()
        {
            ...
            //return AccountSet.Where(account => account.IsEnable==true).ToList();
        ...
        {
            return AccountSet.Where(account => account.Role == AccountRole.Operator && account.IsEnable==true).ToList();
        }
        ...
        {
            return AccountSet.Where(account => account.Role == AccountRole.Admin && account.IsEnable == true).ToList();
        }
        ...
        {
            return AccountSet.Where(account => account.Role == AccountRole.Maintainer && account.IsEnable == true).ToList();
        }
        ...
        public List<Account> SelectAccountsWithRoleLessThan(AccountRole role)
        {
            ...
            if (role == AccountRole.Maintainer )
            {
                return
                    AccountSet.Where(
            ...
            if (role == AccountRole.System)
            {
                return
                    AccountSet.Where(
                        account => account.Role == AccountRole.Operator || account.Role == AccountRole.Admin || account.Role == AccountRole.Maintainer).ToList();
            }

            return new List<Account>();
        }

        public List<Account> SelectNetAccounts()
        {
            return AccountSet.Where(account => account.IsNetAccount == true).ToList();
        }

        public List<Account> SelectAccountsByGroup(string groupName)
        {
            return AccountSet.Where(account => account.GroupName == groupName).ToList();
        }
